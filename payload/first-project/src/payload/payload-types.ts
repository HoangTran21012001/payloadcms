...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "webData".
 */
export interface WebDatum {
  id: string;
  title?: string | null;
  url?: string | null;
  updatedAt: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "sidebarleft".
 */
export interface Sidebarleft {
  id: string;
  title?: string | null;
  hero: {
    type: 'none' | 'highImpact' | 'mediumImpact' | 'lowImpact';
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "sidebarright".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "alllayout".
 */
export interface Alllayout {
  id: string;
  heading: Meta;
  sidbarleft: Meta;
  sidebarright: Meta;
