...
import { Header, Sidebarleft } from '../../../payload/payload-types'
import { fetchHeader, fetchSideBarLeft } from '../../_api/fetchGlobals'
...
export async function Header() {
  ...
  // let side : Sidebarleft | null = null
  try {
    header = await fetchHeader()
    // side = await fetchSideBarLeft()
    // console.log(side)
  } catch (error) {
